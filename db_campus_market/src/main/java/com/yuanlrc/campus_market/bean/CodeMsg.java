...
public class CodeMsg {
	...
	//后台新闻管理
	public static CodeMsg ADMIN_NEWS_ADD_ERROR = new CodeMsg(-9200, "新闻信息添加失败，请联系管理员！");
	public static CodeMsg ADMIN_NEWS_EDIT_ERROR = new CodeMsg(-9201, "新闻信息编辑失败，请联系管理员！");
