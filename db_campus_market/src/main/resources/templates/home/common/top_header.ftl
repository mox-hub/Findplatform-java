...
<header class="ease2">
	    <div class="header-main center ease2">
	        <a href="/home/index/index" class="slogan" style="width:280px;">
	            <h1 class="s-main"></h1>
	            <div class="s-submain"></div>
	           	<span style="font-size:35px;margin-left:-55px;">校园二手交易市场</span>
	        </a>
		        ...
		        <div id="have_login" class="clearfix">
		        	<div id="person_info" class="clearfix">
		        		<a href="../student/index">
		        			<#if student.headPic??>
		        			<img  class="avatar"  style="height:48px;width:48px;" src="/photo/view?filename=${student.headPic}">
		        			<#else>
		        			<img  class="avatar"  style="height:48px;width:48px;" src="/home/imgs/avatar1.png">
		        			</#if>
		        		</a>
			        	<div  style="display:inline;"  class="person_name">
			        		<a href="../student/index" id="id-btn">Hi：${student.nickname!student.sn}</a>
			        	</div>
			        	<div  style="display:inline;"  class="person_name">
